                            ...
                            <div className="card mb-3">
                                ...
                                <div className="card-body">
                                    <div className="row flex-between-center">
                                        ...
                                        <div className="col-xxl-3 mt-4 mt-xxl-0 d-flex justify-content-center">
                                            <ul className="list-unstyled mb-0 d-flex flex-wrap flex-xxl-column gap-3 justify-content-center">
                                                <li><a className="text-800 hover-primary hover-text-decoration-none" href="#!">
                                                    <span className="fas fa-globe"></span><span className="fw-semi-bold ms-2">Website</span></a></li>
                                                <li><a className="text-800 hover-primary hover-text-decoration-none" href="#!">
                                                    <span className="fab fa-linkedin"></span><span className="fw-semi-bold ms-2">LinkedIn</span></a></li>
                                                <li><a className="text-800 hover-primary hover-text-decoration-none" href="#!">
                                                    <span className="fab fa-facebook"></span> <span className="fw-semi-bold ms-2">Facebook</span></a></li>
                                                <li><a className="text-800 hover-primary hover-text-decoration-none" href="#!">
                                                    <span className="fab fa-instagram"></span><span className="fw-semi-bold ms-2">Instagram</span></a></li>
                                                <li><a className="text-800 hover-primary hover-text-decoration-none" href="#!">
                                                    <span className="fab fa-pinterest"></span><span className="fw-semi-bold ms-2">Pinterest</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
