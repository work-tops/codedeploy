                    ...
                    <Col lg={12} className="mt-4">
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Button as={Link} to="/Invoices" className="btn-primary me-2" type="submit">Save</Button>
                                <Button as={Link} to="/Invoices" className="btn-success me-2" type="submit">Save & Send</Button>
            ...
            <div>
                <Modal show={show1} onHide={handleClose1}>
                    ...
                    <Modal.Footer>
                        ...
                        <Button as={Link} to="/Invoices" variant="danger">
                            Yes
                        </Button>
                    </Modal.Footer>
                </Modal>
