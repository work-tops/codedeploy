                ...
                <Col lg={12} className="mt-3">
                    <Container>
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <div data-aos="fade-right" className="row d-flex justify-content-xl-evenly">
                        ...
                        {/* Special Section */}
                        <h1 className="fs-2 text-center fs-sm-4 mb-3 fs-md-5">Frequently Bought Materials</h1>
                        <Swiper
                            slidesPerView={3}
                            spaceBetween={10}
                            // centeredSlides={true}
