                                    ...
                                    <div className="card-header bg-light">
                                        <div className="row flex-between-center">
                                            ...
                                            <div className="col-sm-auto"><a className="btn btn-falcon-default btn-sm" href="#!">
                                                {/* <svg className="svg-inline--fa fa-plus fa-w-14 me-2" data-fa-transform="shrink-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="" style="transform-origin: 0.4375em 0.5em;"><g transform="translate(224 256)"><g transform="translate(0, 0)  scale(0.875, 0.875)  rotate(0 0 0)"><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" transform="translate(-224 -256)"></path></g></g></svg> */}
                                ...
                                <div className="card mb-3">
                                    ...
                                    <div className="card-body">
                                        <form>
                                            ...
                                            <div className="border-bottom border-dashed my-5"></div>
                                            <div className="row">
                                                <div className="col-md-7 col-xl-12 col-xxl-7 px-md-3 mb-xxl-0 position-relative">
                                                    <div className="d-flex"><img className="me-3" src={sheild} alt="" width="60" height="60" />
                                                        <div className="flex-1">
                                                            <h5 className="mb-2">Buyer Protection</h5>
                                                            <div className="form-check mb-0"><input className="form-check-input" id="protection-option-1" type="checkbox"  /><label className="form-check-label mb-0" for="protection-option-1"> <strong style={{fontSize:"14px"}}>Full Refund </strong>If you don't
                                                                {/* <br className="d-none d-md-block d-lg-none"> */}
                                                                receive your order</label></div>
                                                            <div className="form-check"><input className="form-check-input" id="protection-option-2" type="checkbox"  /><label className="form-check-label mb-0" for="protection-option-2"> <strong style={{fontSize:"14px"}}>Full or Partial Refund, </strong>If the product is not as described in details</label></div><a className="fs--1 ms-3 ps-2" href="#!">Learn More
                                                                {/* <svg className="svg-inline--fa fa-caret-right fa-w-6 ms-1" data-fa-transform="down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="caret-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512" data-fa-i2svg="" style="transform-origin: 0.1875em 0.625em;"><g transform="translate(96 256)"><g transform="translate(0, 64)  scale(1, 1)  rotate(0 0 0)"><path fill="currentColor" d="M0 384.662V127.338c0-17.818 21.543-26.741 34.142-14.142l128.662 128.662c7.81 7.81 7.81 20.474 0 28.284L34.142 398.804C21.543 411.404 0 402.48 0 384.662z" transform="translate(-96 -256)"></path></g></g></svg> */}
                                                                <span className="fas fa-caret-right ms-1" data-fa-transform="down-2"></span></a>
                                                        </div>
                                                    </div>
