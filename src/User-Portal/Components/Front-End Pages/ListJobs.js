                                                ...
                                                <Card className='mt-5'>
                                                    <Card.Body>
                                                        <div key={key}>
                                                            ...
                                                            <p className='text-justiy fw-semibold' style={{ fontSize: '14px' }}><Icon icon="mdi:clock-time-eight" color="#003f6b" className='me-1' style={{ marginTop: '-1px' }} width="20" height="20" hFlip={true} />{data?.project_duration}</p>
