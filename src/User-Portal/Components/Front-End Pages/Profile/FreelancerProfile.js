                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-lg-12">
                                <h1 className="mb-1"> Peter Leverkus</h1>
                                <p style={{ fontSize: '18px' }} className="text-primary fw-normal">petergms@gmail.com</p>
                        ...
                        <div className="card mb-3">
                            ...
                            <div className="card-footer bg-light p-0 border-top">
                                <button className="btn btn-link d-block w-100 btn-intro-collapse collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#profile-intro" aria-expanded="false" aria-controls="profile-intro">Show <span className="less">less
                                    {/* <svg className="svg-inline--fa fa-chevron-up fa-w-14 ms-2 fs--1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M240.971 130.524l194.343 194.343c9.373 9.373 9.373 24.569 0 33.941l-22.667 22.667c-9.357 9.357-24.522 9.375-33.901.04L224 227.495 69.255 381.516c-9.379 9.335-24.544 9.317-33.901-.04l-22.667-22.667c-9.373-9.373-9.373-24.569 0-33.941L207.03 130.525c9.372-9.373 24.568-9.373 33.941-.001z"></path></svg> */}
                                </span><span className="full">full
                                        {/* <svg className="svg-inline--fa fa-chevron-down fa-w-14 ms-2 fs--1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M207.029 381.476L12.686 187.132c-9.373-9.373-9.373-24.569 0-33.941l22.667-22.667c9.357-9.357 24.522-9.375 33.901-.04L224 284.505l154.745-154.021c9.379-9.335 24.544-9.317 33.901.04l22.667 22.667c9.373 9.373 9.373 24.569 0 33.941L240.971 381.476c-9.373 9.372-24.569 9.372-33.942 0z"></path></svg> */}
                                    </span></button></div>
                        </div>
                        {/* Bussiness Information */}
                        <Card className="mb-3 font-sans-serif">
                            <Card.Header className="bg-white text-capitalize">
                                <h2>
                                    Bussiness Information
                                </h2>
                            </Card.Header>
                        ...
                        <div className="card mb-3">
                            <div className="card-header bg-light">
                                <div className="row align-items-center">
                                    <div className="col">
                                        <h2 className="mb-0" id="followers">Followers <span className="d-none d-sm-inline-block">(233)</span></h2>
                                    </div>
                                    <div className="col">
                                        <form>
                                            <div className="row g-0">
                                ...
                                <div className="row g-0 text-center fs--1">
                                    <div className="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                                        <div className="bg-white dark__bg-1100 p-3 h-100">
                                            ...
                                            <Link to="/trader-profile-public" className="d-flex justify-content-center">
                                                <h4 className="mb-1 text-primary fs-0">
                                                    Emilia Clarke
                                                </h4>
                                            </Link>
                                            <p className="fs--1 mb-1"><a className="text-700" href="#!">Technext limited</a></p>
                                        </div>
                                    </div>
                                    <div className="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                                        <div className="bg-white dark__bg-1100 p-3 h-100">
                                    ...
                                    <div className="col-6 col-md-4  col-lg-3 col-xxl-2 mb-1">
                                        <div className="bg-white dark__bg-1100 p-3 h-100">
                                            ...
                                            <p className="fs--1 mb-1"><a className="text-700" href="#!">Graduate Student Council</a></p>
                                        </div>
                                    </div>
                                    <div className="col-6 col-md-4 col-lg-3 col-xxl-2 mb-1">
                                        <div className="bg-white dark__bg-1100 p-3 h-100">
                                            ...
                                            <p className="fs--1 mb-1"><a className="text-700" href="#!">Art Club, MIT</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body fs--1">
                                    <div className="d-flex">
                                        <div className="flex-1 position-relative ps-3">
                                            <h3 className="mb-0">Fabricator</h3>
                                    ...
                                    <div className="d-flex">
                                        <div className="flex-1 position-relative ps-3">
                                            <h3 className="mb-0">Kitchen Designer</h3>
