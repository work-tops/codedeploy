                        ...
                        <Col className='' lg={9}>
                            <Card className="mt-5">
                                <Card.Header className="bg-light position-relative">
                                    <h4 className="mb-0 text-uppercase">MY Wishlists</h4>
                                </Card.Header>
                                                ...
                                                <Row className="g-0 h-100">
                                                    <Col lg={8}>
                                                        ...
                                                        <div key={key}>
                                                            ...
                                                            <p className='fifty-chars text-capitalize text-justify' style={{ fontSize: '14px', width: '96%' }}>{data.project_description}</p>
                                                        </div>
                                                    ...
                                                    <Col md={12} lg={4} className=" mt-lg-0">
                                                        {/* <Card className=''>
                                                            <Card.Body> */}
                                                        <div key={key}>
                                                            <p className='text-justiy text-capitalize fw-semibold' style={{ fontSize: '14px' }}><Icon icon="tabler:currency-pound" className='me-1' style={{ marginTop: '-1px' }} color="#003f6b" width="20" height="20" />{getLevel(data?.budget)}</p>
                                                            <p className='text-justiy text-capitalize fw-semibold' style={{ fontSize: '14px' }}><Icon icon="material-symbols:location-on" className='me-1' style={{ marginTop: '-1px' }} color="#003f6b" width="20" height="20" />{data?.location}</p>
                                                            <p className='text-justiy text-capitalize fw-semibold' style={{ fontSize: '14px' }}><Icon icon="material-symbols:folder-rounded" className='me-1' style={{ marginTop: '-1px' }} color="#003f6b" width="20" height="20" /> {data?.category}</p>
                                                            <p className='text-justiy text-capitalize fw-semibold' style={{ fontSize: '14px' }}><Icon icon="mdi:clock-time-eight" color="#003f6b" className='me-1' style={{ marginTop: '-1px' }} width="20" height="20" hFlip={true} />20 to 30 days</p>
                                                            <p className='text-justiy text-capitalize fw-semibold' style={{ fontSize: '14px' }}><Icon icon="mdi:tag" color="#003f6b" className='me-1' style={{ marginTop: '-1px' }} width="20" height="20" hFlip={true} /> Job ID : {data?._id}</p>
                                        ...
                                        <div className="card-body p-0 d-flex flex-column justify-content-between">
                                            <div>
                                                <div className="p-3">
                                                    ...
                                                    <p className='one-twenty-chars text-capitalize mb-lg-0 text-justify' style={{ fontSize: '14px' }}>White Attica
