                                ...
                                <Card.Body className="d-flex p-0 h-100">
                                                ...
                                                <div className="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h4 className="mb-0 chat-contact-title fs-0">Peter Leverkus</h4><span className="message-time fs--2">Tue</span>
                                                                </div>
                                                    ...
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-2" data-bs-toggle="tab" data-bs-target="#chat-2" aria-controls="chat-2" aria-selected="false" tabindex="-1">
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h4 className="mb-0 chat-contact-title fs-0">Jhon Lee</h4><span className="message-time fs--2">Sun</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                    ...
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-2" data-bs-toggle="tab" data-bs-target="#chat-2" aria-controls="chat-2" aria-selected="false" tabindex="-1">
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h4 className="mb-0 chat-contact-title fs-0">Emma Watson</h4><span className="message-time fs--2">Sun</span>
                                                                </div>
                                                                <div className="min-w-0">
                                    ...
                                    <div className="card-chat-content">
                                        <div className="card-chat-pane">
                                            <div className="chat-content-header">
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        <div className="min-w-0">
                                                            <h3 className="mb-0 text-truncate">Peter Leverkus</h3>
                                                            <div className="fs--1 mt-1 text-900">
                                                                Active 7h ago
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="h-100 overflow-auto scrollbar">
                                                        <div className="d-flex position-relative align-items-center p-3 border-bottom">
                                                            ...
                                                            <div className="flex-1 ms-2 d-flex flex-between-center">
                                                                <h4 className="mb-0"><a className="text-decoration-none stretched-link text-700" href="../pages/projectowner/profile.html">Peter Leverkus</a></h4>
                                                    ...
                                                    <div className="d-flex position-relative p-3 border-bottom mb-3 align-items-center">
                                                        ...
                                                        <div className="flex-1">
                                                            <Link to="/trader-profile-public">
                                                                <h4 className="mb-0 fs-1"><a className="text-decoration-none stretched-link text-900">Peter Leverkus</a></h4>
                                                            </Link>
                                                            <p className="mb-0 fs--1 mt-1">You friends with Peter Leverkus. Say hi to start the conversation</p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="d-flex gap-2 justify-content-end m-3">
                                            <Button id="FileUpload1" style={{ background: '#003f6b'}} className="Home-btns-1 border-0">
                                                Attachments
                                            </Button>
                                            <Button as={Link} to="/freelancer/true" style={{ background: '#003f6b'}} className="Home-btns-1 border-0">
                                                Send
                                            </Button>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        <Modal.Header>
                                            <h4 className="text-900">
                                                Forward Message
                                                <small style={{ fontWeight: '400'}} className="d-block mt-2">Select Upto 5 Contacts</small>
                                            </h4>
                                        </Modal.Header>
                                        <Modal.Body>
                                            ...
                                            <div className="d-flex p-3">
                                                ...
                                                <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                    <div className="d-flex justify-content-between">
                                                        <h4 className="mb-0  mt-2 chat-contact-title fs-0">John Lee</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="d-flex p-3">
                                                ...
                                                <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                    <div className="d-flex justify-content-between">
                                                        <h4 className="mb-0  mt-2 chat-contact-title fs-0">Peter Leverkus</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="d-flex p-3">
