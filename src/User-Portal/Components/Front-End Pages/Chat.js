                                        ...
                                        <div className="chat-sidebar">
                                            <div className="contacts-list " data-simplebar="init"><div className="simplebar-wrapper" style={{ margin: "0px" }}><div className="simplebar-height-auto-observer-wrapper"><div className="simplebar-height-auto-observer"></div></div><div className="simplebar-mask"><div className="simplebar-offset" style={{ right: "0px", bottom: "0px" }}><div className="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style={{ height: "100%", overflow: "hidden scroll" }}><div className="simplebar-content" style={{ padding: "0px" }}>
                                                <div className="nav nav-tabs border-0 flex-column" role="tablist" aria-orientation="vertical">
                                                    ...
                                                    {/* <div className="hover-actions-trigger chat-contact nav-item unread-message" role="tab" id="chat-link-3" data-bs-toggle="tab" data-bs-target="#chat-3" aria-controls="chat-3" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Anna Karinina</h6><span className="message-time fs--2">Sat</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">What are you doing?</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="hover-actions-trigger chat-contact nav-item unread-message" role="tab" id="chat-link-4" data-bs-toggle="tab" data-bs-target="#chat-4" aria-controls="chat-4" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">John Lee</h6><span className="message-time fs--2">Mon</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">How are you?</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-5" data-bs-toggle="tab" data-bs-target="#chat-5" aria-controls="chat-5" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            <div className="avatar avatar-xl status-online">
                                                                <div className="avatar-name rounded-circle"><span>BR</span></div>
                                                            </div>
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Bucky Robert</h6><span className="message-time fs--2">Wed</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">You: 👋</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"><svg className="svg-inline--fa fa-check fa-w-16 text-400" data-fa-transform="shrink-5 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.6875, 0.6875)  rotate(0 0 0)"><path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z" transform="translate(-256 -256)"></path></g></g></svg></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-6" data-bs-toggle="tab" data-bs-target="#chat-6" aria-controls="chat-6" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">John Bradley</h6><span className="message-time fs--2">Fri</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">Hello!</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-7" data-bs-toggle="tab" data-bs-target="#chat-7" aria-controls="chat-7" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Rory McCann</h6><span className="message-time fs--2">Sun</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">You: 😮</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"><svg className="svg-inline--fa fa-check fa-w-16 text-400" data-fa-transform="shrink-5 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.6875, 0.6875)  rotate(0 0 0)"><path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z" transform="translate(-256 -256)"></path></g></g></svg></div>
                                                    ...
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-8" data-bs-toggle="tab" data-bs-target="#chat-8" aria-controls="chat-8" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Joe Bempsie</h6><span className="message-time fs--2">Wed</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">Hello!</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"></div>
                                                    ...
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-9" data-bs-toggle="tab" data-bs-target="#chat-9" aria-controls="chat-9" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Diana Rigg</h6><span className="message-time fs--2">Mon</span>
                                                                </div>
                                                                <div className="min-w-0">
                                                    ...
                                                    <div className="hover-actions-trigger chat-contact nav-item" role="tab" id="chat-link-10" data-bs-toggle="tab" data-bs-target="#chat-10" aria-controls="chat-10" aria-selected="false" tabindex="-1">
                                                        <div className="d-md-none d-lg-block">
                                                            <div className="dropdown dropdown-active-trigger dropdown-chat"><button className="hover-actions btn btn-link btn-sm text-400 dropdown-caret-none dropdown-toggle end-0 fs-0 mt-4 me-1 z-index-1 pb-2 mb-n2" type="button" data-boundary="viewport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg className="svg-inline--fa fa-cog fa-w-16" data-fa-transform="shrink-3 down-4" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cog" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style={{ transformOrigin: "0.5em 0.75em" }}><g transform="translate(256 256)"><g transform="translate(0, 128)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z" transform="translate(-256 -256)"></path></g></g></svg></button>
                                                                <div className="dropdown-menu dropdown-menu-end border py-2 rounded-2"><a className="dropdown-item" href="#!">Mute</a>
                                                                    <div className="dropdown-divider"></div><a className="dropdown-item" href="#!">Archive</a><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        ...
                                                        <div className="d-flex p-3">
                                                            ...
                                                            <div className="flex-1 chat-contact-body ms-2 d-md-none d-lg-block">
                                                                <div className="d-flex justify-content-between">
                                                                    <h6 className="mb-0 chat-contact-title">Gemma Whelan</h6>
                                                                </div>
                                                                <div className="min-w-0">
                                                                    <div className="chat-contact-content pe-3">Say hi to your new friend</div>
                                                                    <div className="position-absolute bottom-0 end-0 hover-hide"></div>
                                                                </div>
                                                            </div>
                                                        </div>
