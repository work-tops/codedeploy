                ...
                <div className="col-lg-8 pe-lg-2">
                    <div className="card mb-3">
                        ...
                        <div className="card-body">
                            <p className="text-justify text-capitalize mb-0 ps-3">
                    ...
                    <div className="card mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-justify text-capitalize mb-3 ps-3">
                            ...
                            <p className="text-justify text-capitalize mt-3 ps-3">
                    ...
                    <div className="card mb-3">
                        ...
                        <div className="card-body">
                            ...
                            <p className="text-justify text-capitalize mb-0 ps-3">Nothing in these Terms is intended to or shall operate to create a partnership between the parties, or authorize either party to act as agent for the other, and neither party shall have the authority to act in the name or on behalf of or otherwise to bind the other in any way (including, but not limited to, the making of any representation or warranty, the assumption of any obligation or liability and the exercise of any right or power).</p>
                            <hr className="my-4"></hr>
                            <h6 className="text-primary">Third party rights</h6>
                            <p className="text-justify text-capitalize mb-0 ps-3">These Terms do not confer any rights on any person or party other than you and us.</p>
                            <hr className="my-4"></hr>
                            ...
                            <p className="text-justify text-capitalize mb-0 ps-3">These Terms are governed by USA law and you can bring legal proceedings in respect of the products in the USA courts. As a consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident. Nothing in these terms and conditions, including this clause 30, affects your rights as a consumer to rely on such mandatory provisions of local law.</p>
                            <p className="text-justify text-capitalize pt-2">Thank you for taking the time to read these Terms.</p>
