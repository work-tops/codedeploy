...
import { Button, Col, Card, Row, Container, Form, NavDropdown } from "react-bootstrap";
                                ...
                                <div className="card mb-3">
                                    ...
                                    <div className="card-body">
                                        <Form>
                                            ...
                                            <div className="form-check"><input className="form-check-input" id="flexCheckChecked" type="checkbox" value="" /><label className="form-check-label" for="flexCheckChecked">Same as Shipping Address</label></div>
                                            <Form.Group className="mb-3">
                                                <Form.Label className="text-uppercase">
