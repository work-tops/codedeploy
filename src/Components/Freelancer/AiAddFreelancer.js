                            ...
                            <div>
                                ...
                                <form onSubmit={(e) => { formsubmit(e) }} className="add-seller-form">
                                    ...
                                    <fieldset className="tag-box">
                                        <span class="badge skill-tag p-2 bg-success">HTML <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">CSS <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">Javascript <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">HTML <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">CSS <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">Javascript <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">React <i class="tag-close ri-close-fill"></i></span>
                                        <span class="badge skill-tag p-2 bg-success">React <i class="tag-close ri-close-fill"></i></span>
                                    </fieldset>
